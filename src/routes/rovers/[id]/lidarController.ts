...
export class LidarMiniController {
  ...
  get isConnected(): boolean { return !!this._socket && this._socket.readyState === WebSocket.OPEN; }
  get lastScan(): LidarScan | null { return this._scan; }
...
export function createAndConnectMiniLidar(options: { canvas: HTMLCanvasElement | string } & Omit<LidarMiniControllerOptions, 'canvasId'>): LidarMiniController {
